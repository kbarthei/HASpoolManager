...
- **docs:** regenerate CHANGELOG.md [skip ci] (`cc931f5`)
...
- **docs:** regenerate CHANGELOG.md [skip ci] (`c1e1012`)
...
- **fix:** correct section selectors + scroll-into-view (`1cd9f8f`)
- **docs:** regenerate CHANGELOG.md [skip ci] (`ee8978d`)
...
- **docs:** regenerate CHANGELOG.md [skip ci] (`a6fc6c0`)
...
- **test:** inventory multi-AMS/multi-rack + admin RacksCard + AmsUnitsCard (`e735c1c`)
- **feat:** ReceiveWizard supports multi-rack with selector (`9868003`)
- **feat:** admin AmsUnitsCard with rename + enable toggle per unit (`dcde463`)
- **feat:** admin RacksCard with create / edit / archive / restore (`be50567`)
- **feat:** inventory renders N AMS units and N racks data-driven (`25d7c1d`)
- **feat:** rack helpers + queries + actions for multi-rack (`9f44246`)
- **feat:** upsert printer_ams_units during HA discovery (`7754143`)
- **test:** dedicated multi-AMS sync tests (0/1/2 units + HT) (`6364c04`)
- **feat:** dynamic SLOT_DEFS + rename payload keys for multi-AMS (`e50ff0a`)
- **feat:** buildSlotDefs helper + ams-config endpoint (`4083d67`)
- **feat:** AMS-units list + update with disable side-effects (`821b694`)
- **feat:** racks CRUD + archive endpoints (`1abacd5`)
- **feat:** zod schemas for rack and AMS-unit APIs (`24c21fb`)
- **test:** end-to-end migration for multi-rack and multi-AMS (`b95253c`)
- **feat:** add racks + printer_ams_units schema and backfill (`9d4b28c`)
- **feat:** importable migration module for rack + AMS unit backfill (`110b91f`)
- **test:** migration helpers for location rewrite and AMS unit derivation (`5059f0c`)
- **feat:** drop printers.ams_count column (`1c15916`)
- **feat:** add printer_ams_units table for AMS topology (`49de26f`)
- **feat:** add racks table for multi-rack support (`4c147e6`)
- **docs:** regenerate CHANGELOG.md [skip ci] (`c7f29e7`)
